...
<template>
  <div class="cms-metadata-panel">
    <Form v-slot="$form" :resolver="resolver" class="flex flex-col gap-4">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <div class="lg:col-span-4 col-span-12">
          <label for="meta-title">{{ t('metadataPanel.metaTitle') }}</label>
        </div>
        <div class="lg:col-span-8 col-span-12">
          <InputText name="meta-title" class="w-full" />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div class="lg:col-span-8 col-span-12">
          <Textarea name="meta-description" class="w-full" :rows="4" />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div class="lg:col-span-8 col-span-12">
          <InputText name="open-graph-image" class="w-full" />
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div class="lg:col-span-8 col-span-12">
          <InputText name="tags" class="w-full" />
